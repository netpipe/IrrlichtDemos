...
//============================================================================//
//////////////////////////////////////////////////h
#define _IRR_COMPILE_WITH_MDL3_MESH_LOADER_
#ifndef __C_MDL3_MESH_LOADER_H_INCLUDED__
#define __C_MDL3_MESH_LOADER_H_INCLUDED__
...
namespace scene
{
    ...
    class IMDL3Mesh:public IAnimatedMesh
    {
    public:typedef core::vector3d<f32> v3f;typedef core::vector2d<f32> v2f;
        ...
        IMDL3Mesh(scene::ISceneManager*smgr);
...
namespace scene
{
    class CMDL3MeshLoader:public IMeshLoader
    {
    public:

       CMDL3MeshLoader(scene::ISceneManager*smgr);
...
#endif // __C_MDL3_MESH_LOADER_H_INCLUDED__
//////////////////////////////////////////////////h
