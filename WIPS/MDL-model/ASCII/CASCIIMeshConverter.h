...
//============================================================================//
//////////////////////////////////////////////////h
#define _IRR_COMPILE_WITH_ASCII_MESH_LOADER_
#ifndef __C_ASCII_MESH_LOADER_H_INCLUDED__
#define __C_ASCII_MESH_LOADER_H_INCLUDED__
...
namespace scene
{
    ...
    class IASCIIMesh:public IAnimatedMesh
    {
    public:typedef core::vector3d<f32> v3f;typedef core::vector2d<f32> v2f;
        ...
        IASCIIMesh(scene::ISceneManager*smgr);
        ...
        virtual bool createMesh(IAnimatedMesh*im);
        virtual bool WriteASCII(const c8*fname);
        virtual bool WriteMD2(const c8*fname);
...
namespace scene
{
    class CASCIIMeshConverter:public IMeshLoader
    {
    public:

       CASCIIMeshConverter(scene::ISceneManager*smgr);
...
#endif // __C_ASCII_MESH_LOADER_H_INCLUDED__
//////////////////////////////////////////////////h
