	...
	*/
	...
	public:
		...
		*/
		...
		/**  
		Find the id of a the material renderer with the name \c name.
		\param name The material name to find.
		\return the index of the material renderer or -1 if no material was found.
		\see IMaterialSystem. 
		*/
		virtual s32 findMaterialRendererId(const c8 *name) = 0;
		...
		\return a pointer to the Material System
		\see IMaterialSystem.
		*/
