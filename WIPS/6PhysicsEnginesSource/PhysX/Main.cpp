...
void ThrowBox()
{
	...
	NxActor *actor = Physics->setPhysics(node,10.0);
	...
	actor->addForce(NxVec3(newpos[0],newpos[1],newpos[2]),NX_IMPULSE);
...
int main(int argc, char **argv)
{
	...
	device->setWindowCaption(L"PhysXClass Test Environment");
