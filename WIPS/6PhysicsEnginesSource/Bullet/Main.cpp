...
void ThrowBox()
{
	...
	btRigidBody* body = Physics->setPhysics(node,10.0);
	...
	body->applyCentralImpulse(btVector3(newpos[0],newpos[1],newpos[2]));
...
int main(int argc, char **argv)
{
	...
	device->setWindowCaption(L"BulletClass Test Environment");
	...
	Physics = new BulletClass(device);
...
//				Physics->setSoftBody(node,"Meshes/techcon2.3ds",1.0);
