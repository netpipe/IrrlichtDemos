...
namespace scene
{
	...
	public:
		...
		//! the corrsesponding joint, if the mesh in this scene node is a Skinned or Joint mesh.
		virtual ISceneNode* getJointNode(const core::stringc& jointName);
	...
	private:
		...
		core::array<CJointSceneNode* > JointSceneNodes;
