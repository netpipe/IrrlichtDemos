...
#ifndef __I_SCENE_NODE_ANIMATOR_CAMERA_TOUCH_H_INCLUDED__
#define __I_SCENE_NODE_ANIMATOR_CAMERA_TOUCH_H_INCLUDED__
...
namespace scene
{
	...
	*/
	class ISceneNodeAnimatorCameraTouch : public ISceneNodeAnimator
	{
	public:
