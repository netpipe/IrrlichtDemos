...
class IIrrOdeDevice {
  public:
     ...
     * The step functions
     */
    virtual void step(f32 fTime, CIrrOdeWorld *pWorld, u32 iJointGroupId)=0;
    virtual void quickStep(f32 fTime, CIrrOdeWorld *pWorld, u32 iJointGroupId)=0;
    ...
    virtual void bodySetQuaternion(u32 iBody, vector3df rot)=0;
    ...
    virtual void bodySetFiniteRotationMode(u32 iBody, s32 i)=0;
    virtual s32 bodyGetFiniteRotationMode(u32 iBody)=0;
