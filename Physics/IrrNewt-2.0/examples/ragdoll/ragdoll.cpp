...
int main(int argc, char** argv) {
	...
	//load ragdoll texture
	ragtext = driver->getTexture("C:\\raffaele\\programmazione\\irrnewt\\media\\ragdoll-texture.jpg");
	if(ragtext==NULL)
	{
	    std::cout << "ragdoll texture not kloaded!";
	    system("pause");
	    exit(0);
    }
...
//	world_node->setMaterialType(video::EMT_LIGHTMAP_M4);
	...
	//create a sphere
	scene::ISceneNode* sphere_node = smgr->addSphereSceneNode(10);
	sphere_node->setMaterialTexture(0,ragtext);
