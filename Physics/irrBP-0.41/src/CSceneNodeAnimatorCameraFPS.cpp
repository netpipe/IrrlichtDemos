...
//! constructor
CSceneNodeAnimatorCameraFPS::CSceneNodeAnimatorCameraFPS(CIrrBPRigidBody * cambody,gui::ICursorControl* cursorControl,
...
void CSceneNodeAnimatorCameraFPS::animateNode(ISceneNode* node, u32 timeMs)
{
	...
	if (CursorKeys[EKA_MOVE_FORWARD])
	{
		...
		body->applyCentralImpulse(movedir * timeDiff * MoveSpeed);
	}
	...
	//	body->setPosition(pos);
		body->applyCentralImpulse(strafevect * timeDiff * MoveSpeed);
	}
...
ISceneNodeAnimator* CSceneNodeAnimatorCameraFPS::createClone(ISceneNode* node, ISceneManager* newManager)
{
	CSceneNodeAnimatorCameraFPS * newAnimator =
		new CSceneNodeAnimatorCameraFPS(body,CursorControl,	RotateSpeed, MoveSpeed, JumpSpeed,
