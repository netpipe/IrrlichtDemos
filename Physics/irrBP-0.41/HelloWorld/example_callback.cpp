...
int main()
{
	...
	box= bulletmgr->addRigidBox(Node,1);
	box->setRotation(vector3df(10,10,10));
	CIrrBPBoxBody * box2;
	for(int i=0;i<100;i++)
	{
	Node2 = smgr->addCubeSceneNode(5,0,-1,vector3df(0,50 +(i*7),0));
...
//	bulletmgr->getWorld()->setDebugDrawerFlags(DBG_DrawWireframe);
