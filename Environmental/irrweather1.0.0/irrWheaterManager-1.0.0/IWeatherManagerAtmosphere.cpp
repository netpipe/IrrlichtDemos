...
void IWeatherManagerAtmosphere::CreateSkyPalette()
{
    ...
    Rain = new IAtmosphereRainSceneNode(smgr->getActiveCamera(), smgr, driver->getTexture("../../Data/raindrop.png"), driver->getTexture("../../Data/snow.png"));
...
//    Sky->setDebug../../DataVisible(scene::EDS_FULL);
//    Star->setDebug../../DataVisible(scene::EDS_FULL);
...
//    Sunlight->getLight../../Data().DiffuseColor = video::SColorf(video::SColor(SkyPixel.getRed(), SkyPixel.getGreen(), SkyPixel.getBlue(), 1.f));
