...
public:
	...
	void pack(const irr::core::array<irr::core::rect<irr::u32> >&, irr::core::array<irr::core::array<SPacked> >&, irr::u32);
	void clear();
	void fill(int pack);
...
public:
	...
	irr::core::dimension2du findOptimalPackingArea(irr::core::array<irr::core::rect<irr::u32> >);
