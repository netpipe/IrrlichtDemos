...
public:
	...
	CFlagSceneNode(ISceneNode* parent, ISceneManager* mgr,s32 id, CWindGen* wgen,
        ...
        const vector3df& grav = vector3df(0.0f,-0.0f,0.000f),
	...
	virtual void OnAnimate(u32 timeMs)
	{
		...
		ISceneNode::OnAnimate(timeMs* 0.01f);
	}
...
private:
	...
	void Initialize(int xsubdiv, int ysubdiv, float FlagSize);
