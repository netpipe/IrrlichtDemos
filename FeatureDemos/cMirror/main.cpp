...
int IRRCALLCONV main(int argc, char* argv[])
{
	...
	*/
	...
	printf("Please select the driver you want for this example:\n"\
		" (a) Direct3D 9.0c - Works\n (b) Direct3D 8.1 - Doesnt support Render to Texture\n"\
		"(c) OpenGL 1.5 - Works\n"\
		" (d) Software Renderer - Quake map on crack.\n"\
		"(e) Burning's Software Renderer - Slow(On my machine: FPS~4)\n"\
		" (f) NullDevice -Crashes \n (otherKey) exit\n\n");
