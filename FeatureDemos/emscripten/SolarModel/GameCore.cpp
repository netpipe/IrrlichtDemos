...
//pGame->Device = device2;
	...
	//	pGame->Device = createDevice(video::EDT_OGLES2, core::dimension2du(1280,800), 16, false, false, false, pGame->EventReceiver);
...
void GameDefaults(GameStruct *pGame)
{
	...
	pGame->Device = NULL;
	pGame->Video = NULL;
	pGame->DriverType = video::EDT_OGLES2;
	pGame->GUI = NULL;
	pGame->Logger = NULL;
	pGame->Scene = NULL;
...
int main(){
	...
	//IrrlichtDevice * device = createDevice(video::EDT_OGLES2, core::dimension2du(1280,800), 16, false, false, false,Game.EventReceiver);

	GameCreateIrrLicht(&Game); //added device param for testing
	//was complaining about being opengl instead of opengles
