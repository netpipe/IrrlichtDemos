...
export EMSCRIPTEN=/home/Dev/libs/Scripting/emsdk/upstream/emscripten
...
CXXFLAGS="-DNEED_WCHAR_FUNCTIONS --preload-file usr/" $EMSCRIPTEN/emmake make -j 2 -o speak.html
#mv speak speak.bc

#CXXFLAGS="-DNEED_WCHAR_FUNCTIONS --preload-file usr/"; emmake make -j2 -o speak.html
