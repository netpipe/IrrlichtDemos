...
CTransitionPostProc::CTransitionPostProc( IPostProc* follow1, IPostProc* follow2, irr::core::dimension2d<irr::s32> sOut, irr::video::ITexture* m ) : IPostProc( follow1, sOut ) {
	...
	if( supported ) {
		...
		matFast.TextureLayer[ 0u ].TextureWrap = irr::video::ETC_CLAMP_TO_EDGE;
		matFast.TextureLayer[ 1u ].TextureWrap = irr::video::ETC_CLAMP_TO_EDGE;
