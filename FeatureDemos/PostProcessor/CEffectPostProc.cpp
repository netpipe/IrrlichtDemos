...
CEffectPostProc::CEffectPostProc( IPostProc* follow1, irr::core::dimension2d<irr::s32> sOut, POSTPROC_EFFECTID effectID, irr::f32 para1, irr::f32 para2, irr::f32 para3, irr::f32 para4, irr::f32 para5, irr::f32 para6, irr::f32 para7, irr::f32 para8 ) : IPostProc( follow1, sOut ) {
	...
	if( supported ) {
		...
		mat.FogEnable = false;
		mat.ZBuffer = 0;
		mat.TextureLayer[ 0u ].TextureWrap = irr::video::ETC_CLAMP_TO_EDGE;
...
CEffectPostProc::CEffectPostProc( IPostProc* follow1, irr::core::dimension2d<irr::s32> sOut, irr::io::IReadFile* file_gl, irr::io::IReadFile* file_dx, irr::video::E_PIXEL_SHADER_TYPE gl_ps, irr::video::E_PIXEL_SHADER_TYPE dx_ps, irr::video::E_MATERIAL_TYPE optimize, irr::f32 para1, irr::f32 para2, irr::f32 para3, irr::f32 para4, irr::f32 para5, irr::f32 para6, irr::f32 para7, irr::f32 para8 ) : IPostProc( follow1, sOut ) {
	irr::video::IVideoDriver* driver = smgr->getVideoDriver( );
	useTextureOptimize = optimize;
	eff = PP_CUSTOM;
