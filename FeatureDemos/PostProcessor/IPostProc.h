...
class IPostProc {
private:
	void init( irr::core::dimension2d<irr::s32> sOut );
	bool pre;
	bool busy;
	IPostProc* follows[4];
...
protected:
	...
	IPostProc( irr::scene::ISceneManager* sm, irr::core::dimension2d<irr::s32> sOut = irr::core::dimension2d<irr::s32>( 0, 0 ) );
	IPostProc( IPostProc* follow1, irr::core::dimension2d<irr::s32> sOut = irr::core::dimension2d<irr::s32>( 0, 0 ) );
...
public:
	...
	irr::core::dimension2d<irr::s32> getOutputSize( ) { return output->getSize( ); }
