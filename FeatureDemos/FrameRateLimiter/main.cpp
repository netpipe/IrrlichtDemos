...
double now = device->getTimer()->getRealTime();

int delay = 25; //was 40fps here at 25
if (now - then < delay)
{
   device->sleep(delay - (now - then));
}
...
//  evice->getTimer()->tick();
//  timeThisFrame = evice->getTimer()->getTime();
//}
//
