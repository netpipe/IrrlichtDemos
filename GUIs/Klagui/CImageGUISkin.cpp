...
void CImageGUISkin::draw3DTabButton(IGUIElement* element, bool active,
		const core::rect<s32>& rect, const core::rect<s32>* clip, EGUI_ALIGNMENT align)
{
    FallbackSkin->draw3DTabButton(element, active, rect, clip, align);
}
...
void CImageGUISkin::draw3DTabBody(IGUIElement* element, bool border, bool background,
		...
		int tabHeight, EGUI_ALIGNMENT align)
{
    FallbackSkin->draw3DTabBody(element, border, background, rect, clip, tabHeight, align);
}
