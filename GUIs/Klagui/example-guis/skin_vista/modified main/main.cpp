...
int main()
{
    ...
    env->addButton( core::rect<s32>(380,320,480,360), win, 1000, L"Exit Demo!" );
    ...
    gui::CGUIProgressBar* bar = new gui::CGUIProgressBar(env->getRootGUIElement(), env, core::rect<s32>(40,260,470,300));
