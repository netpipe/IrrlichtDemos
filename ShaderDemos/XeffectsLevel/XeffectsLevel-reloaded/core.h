...
void Core::init_device(const char * winName)
{
	...
	this->effect_handler = new effectHandler(this->device, irr::core::dimension2d<irr::u32>(mapRes2,mapRes2) ,"",irr::core::dimension2d<irr::u32>(CORE_WINDOW_WIDTH, CORE_WINDOW_HEIGHT));//this->driver->getScreenSize()
...
//
	...
	this->effect_handler->setAmbientColor(irr::video::SColor(255, 10, 10, 10));
	 ...
	 device->getFileSystem()->addFileArchive("./media/egyptians.pk3");
}
