/**Example of triplanar mapping with 6 textures (3 diffuse textures and 3 normal maps)*/
...
//shader compilation
	...
	//The actual shader compilation
		...
		filenameP = "../data/triplanarMapping6TP";
...
//We set the shader, the textures and the colors...
		...
		terrain->getMaterial(0).setTexture(2,drv->getTexture("../data/dirt.png"));
		terrain->getMaterial(0).setTexture(3,drv->getTexture("../data/rockn.png"));
		terrain->getMaterial(0).setTexture(4,drv->getTexture("../data/grassn.png"));
		terrain->getMaterial(0).setTexture(5,drv->getTexture("../data/rockn.png"));
