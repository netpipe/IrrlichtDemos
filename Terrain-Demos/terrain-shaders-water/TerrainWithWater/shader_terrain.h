...
"void main( void )"
"{"
"   vec4 base = texture2D(tex2, Texcoord.xy * 20.0 );"
"   base = mix(base, texture2D(tex3, Texcoord.xy * 20.0 ), texture2D(tex1, Texcoord.xy).r);"
"   base = mix(base, texture2D(tex4, Texcoord.xy * 20.0 ), texture2D(tex1, Texcoord.xy).g);"
"	gl_FragColor = base;"
