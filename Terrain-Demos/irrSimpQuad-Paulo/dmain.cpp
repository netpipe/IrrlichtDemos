...
//cubeMesh->setsetMaterialTexture(0, driver->getTexture("data/textures/trees/OakLeaf.png"));

    ISceneNode * cubeSceneNode = smgr->addMeshSceneNode(cubeMesh);
    smgr->addCubeSceneNode(10.0f, NULL, -1, core::vector3df(0,0,0));
