...
float getHeight1(float x, float z)
{
...
float RidgedMultiFractal(float height, float H, float lacunarity, float octaves, float offset, float gain)
{
...
{
#ifdef rigid
return(RidgedMultiFractal(getHeight1(x,z), 1, 3, 3, 1, 1));
#endif
#ifdef simplex
return(getHeight1(x,z));
#endif
}
