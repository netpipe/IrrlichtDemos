...
int main(){
	IrrlichtDevice *device = createDevice(EDT_OPENGL, dimension2du(640, 480), 16, false, false, false, 0);
  ...
  CGUIClock* guiClock = new CGUIClock(rect<s32>(10,10,150,150), device, guienv->getRootGUIElement());
  guiClock->drop();
