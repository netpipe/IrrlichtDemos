...
CGUIClock::CGUIClock(core::rect<s32> rect,irr::IrrlichtDevice* device, IGUIElement* parent,
                    video::E_MATERIAL_TYPE materialtype): IGUIElement(/* IrrExt13_ClockGUI */ EGUIET_ELEMENT,
                    device->getGUIEnvironment(), parent, -1, rect){
