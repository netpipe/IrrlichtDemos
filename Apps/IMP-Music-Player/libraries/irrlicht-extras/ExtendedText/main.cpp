...
int main()
{
    ...
    //gui::IGUIWindow* win = guienv->addWindow( core::rect<s32>(50,20,210,220) );
    ...
    gui::CGUIExtendedText* text = new gui::CGUIExtendedText( guienv, panel, -1, core::rect<s32>(0,0,160,250) );
    ...
    */
    ...
    while ( device->run() )
    {
        ...
        swprintf( &caption[0], L"FPS: %i", driver->getFPS() );
