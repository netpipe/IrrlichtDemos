...
class IPostProc {
private:
	void init( irr::core::dimension2du sOut );
	bool pre;
	bool busy;
	IPostProc* follows[4];
...
protected:
	...
	IPostProc( irr::scene::ISceneManager* sm, irr::core::dimension2du sOut = irr::core::dimension2du( 0, 0 ) );
	IPostProc( IPostProc* follow1, irr::core::dimension2du sOut = irr::core::dimension2du( 0, 0 ) );
...
public:
	...
	irr::core::dimension2du getOutputSize( ) { return output->getSize( ); }
