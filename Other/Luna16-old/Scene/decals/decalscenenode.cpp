...
void DecalSceneNode::Setup(irr::core::vector3df normal,
...
//if (normal.X > normal.Y & normal.X > normal.Z){XBIG = true;
//up_vector = vector3df(1.0f, 0.0f, 0.0f);
//}
//else if (normal.Y > normal.X & normal.Y > normal.Z){YBIG = true;
//up_vector = vector3df(0.0f, 1.0f, 0.0f);
//}
//else if (normal.Z > normal.Y & normal.Z > normal.X){ZBIG = true;
...
//}
       ...
       vector3df squarepA=intersection + ((-v1 -v3)* basesize);
       vector3df squarepB=intersection + ((v1 - v3)* basesize);
       vector3df squarepC=intersection + ((v1 + v3)* basesize);
       vector3df squarepD=intersection + ((v1 + v3)* basesize);
