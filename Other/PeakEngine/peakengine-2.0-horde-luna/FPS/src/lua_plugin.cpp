/*
** Lua binding: plugin
** Generated automatically by tolua++-1.0.92 on Mon Jun  1 15:23:07 2009.
*/
...
#ifndef TOLUA_DISABLE_tolua_plugin_PlayerEntity_new00
static int tolua_plugin_PlayerEntity_new00(lua_State* tolua_S)
{
...
#ifndef TOLUA_DISABLE_tolua_plugin_PlayerEntity_new00_local
static int tolua_plugin_PlayerEntity_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_PlayerEntity_delete00
static int tolua_plugin_PlayerEntity_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_PlayerEntity_load00
static int tolua_plugin_PlayerEntity_load00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_PlayerEntity_update00
static int tolua_plugin_PlayerEntity_update00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_PlayerEntity_setMovement00
static int tolua_plugin_PlayerEntity_setMovement00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_PlayerEntity_setRotation00
static int tolua_plugin_PlayerEntity_setRotation00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_WeaponEntity_new00
static int tolua_plugin_WeaponEntity_new00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_WeaponEntity_new00_local
static int tolua_plugin_WeaponEntity_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_WeaponEntity_delete00
static int tolua_plugin_WeaponEntity_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_WeaponEntity_load00
static int tolua_plugin_WeaponEntity_load00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_plugin_WeaponEntity_update00
static int tolua_plugin_WeaponEntity_update00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
TOLUA_API int tolua_plugin_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"PlayerEntity");
   tolua_function(tolua_S,"new",tolua_plugin_PlayerEntity_new00);
   tolua_function(tolua_S,"new_local",tolua_plugin_PlayerEntity_new00_local);
   tolua_function(tolua_S,".call",tolua_plugin_PlayerEntity_new00_local);
   tolua_function(tolua_S,"delete",tolua_plugin_PlayerEntity_delete00);
   tolua_function(tolua_S,"load",tolua_plugin_PlayerEntity_load00);
   tolua_function(tolua_S,"update",tolua_plugin_PlayerEntity_update00);
   tolua_function(tolua_S,"setMovement",tolua_plugin_PlayerEntity_setMovement00);
   tolua_function(tolua_S,"setRotation",tolua_plugin_PlayerEntity_setRotation00);
  ...
  tolua_beginmodule(tolua_S,"WeaponEntity");
   tolua_function(tolua_S,"new",tolua_plugin_WeaponEntity_new00);
   tolua_function(tolua_S,"new_local",tolua_plugin_WeaponEntity_new00_local);
   tolua_function(tolua_S,".call",tolua_plugin_WeaponEntity_new00_local);
   tolua_function(tolua_S,"delete",tolua_plugin_WeaponEntity_delete00);
   tolua_function(tolua_S,"load",tolua_plugin_WeaponEntity_load00);
   tolua_function(tolua_S,"update",tolua_plugin_WeaponEntity_update00);
  tolua_endmodule(tolua_S);
 tolua_endmodule(tolua_S);
 return 1;
}
