...
// Originally written by Nikolaus Gebhardt for the Irrlicht engine http://irrlicht.sourceforge.net
// This file was part of the Lightfeather 3D-Engine.
/*
...
#ifndef _PEAKGRAPHICS_KEYCODE_HPP_
#define _PEAKGRAPHICS_KEYCODE_HPP_

namespace peak
{
	enum KeyCode
	{
		KEY_NONE             = 0x00,  // just for initialization
		...
		KEY_PGUP             = 0x21,  // PAGE UP key
		KEY_PGDN             = 0x22,  // PAGE DOWN key
		...
		KEY_SEMICOLON        = 0xBA,  // Semi Colon (;)
		KEY_PLUS             = 0xBB,  // Plus / Equals Key (+ / =)
		KEY_COMMA            = 0xBC,  // Comma Key  (,)
		KEY_MINUS            = 0xBD,  // Minus Key  (-)
		KEY_PERIOD           = 0xBE,  // Period Key (.)
		KEY_SLASH            = 0xBF,  // Forward slash (/)
		KEY_TICK             = 0xC0,  // Forward tick (')
		KEY_OPENSQUARE       = 0xDB,  // Open square bracket ([)
		KEY_BACKSLASH        = 0xDC,  // Back slash (\)
		KEY_CLOSESQUARE      = 0xDD,  // Close square bracket (])
		KEY_HASH             = 0xDE,  // Hash / Sharp / Octothorp (#)
		KEY_BACKTICK         = 0xDF,  // Back tick (`)
