...
peak.Plugin:addPlugin("plugins/libTestPlugin");
...
overlay = peak.TextureOverlay:new("testoverlay.material.xml");
...
overlay3 = peak.LabelOverlay:new("Label Overlay!", "font.material.xml", overlay);
overlay3:setPosition(peak.Vector2D(0, 0));
overlay3:setSize(peak.Vector2D(1, 0.2));
