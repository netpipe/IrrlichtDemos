...
void TKNetwork::bufferMessage(std::string message)
{
...
void TKNetwork::connectToServer(std::string ip, int port)
{
...
void TKNetwork::createClient()
{
    client = enet_host_create (NULL /* create a client host */,
                ...
                0,0 /* 56K modem with 14 Kbps upstream bandwidth */);
...
void TKNetwork::sendMessage(std::string message)
{
...
void TKNetwork::serverListen()
{
    ...
    while (enet_host_service (host, & event, 10) > 0 || listen)
    {
        ...
        case ENET_EVENT_TYPE_RECEIVE:
            ...
            if(msg!="")
            {
                //if(isServer()) bufferMessage(msg);///JOGO PARA 2 JOGADORES<<
...
void TKNetwork::setTKCore(TKCore* ntkCore)
{
    tkCore=ntkCore;
}
