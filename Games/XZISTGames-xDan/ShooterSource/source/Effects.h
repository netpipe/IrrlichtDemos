...
public:
    ...
    void meshSpray(scene::IAnimatedMesh **, u16, core::vector3df,
        core::vector3df, core::vector3df, core::vector3df);
    scene::IParticleSystemSceneNode *particleSpray(
        video::ITexture *, scene::IAnimatedMesh **, u16,
        core::vector3df, core::vector3df, u16, u32, u32,
        f32 = 0.4f
        );
    void flyText(core::stringw);
