...
int userDragging_positionScroolbar = 0; // 0 = no, 1 = yes
s32 ScroolbarPosition              = 0;

int userDragging_volumeScroolbar   = 0; // 0 = no, 1 = yes
s32 ScroolbarVolume                = 0;

int userDragging_pitchScroolbar    = 0; // 0 = no, 1 = yes
   ...
   virtual bool OnEvent(const SEvent& e){
      ...
      switch(e.EventType){
         ...
         case EET_GUI_EVENT :
            ...
            userDragging_positionScroolbar = 1;
            };
