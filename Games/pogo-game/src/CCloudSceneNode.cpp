...
Material.MaterialType=video::EMT_TRANSPARENT_ALPHA_CHANNEL;
            ...
            video::ITexture * txture = mgr->getVideoDriver()->getTexture("smoke.tga");
            Material.setTexture(0,txture);
...
//! Returns amount of materials used by this scene node.
        u32 CCloudSceneNode::getMaterialCount()
        {
            return 1;
        }
...
//! render
        void CCloudSceneNode::render()
        {
            ...
            for (u32 i=sp; i<ParticlesToDraw; i++)
            {
                ...
                p[0+idx].Color	= video::SColor(0,255,255,255);
                ...
                p[1+idx].Color  =video::SColor(0,255,255,255);
                ...
                p[2+idx].Color  = video::SColor(0,255,255,255);
                //p[2+idx].Normal = view;
                ...
                p[3+idx].Color = video::SColor(0,255,255,255);
                // p[3+idx].Normal = view;
        ...
        */
        ...
        void CCloudSceneNode::makeRandomCloud(s16 count)
        {
            ...
            for (i=1; i<count+25; i++)
            {
                ...
                int f2 = int(rand())%190;
                f2+=1;
                ParticleData[i].color = video::SColor(255,255,255,255-f2);
