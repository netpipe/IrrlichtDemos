...
void gameManager::gameManagerLoop(f32 frameDeltaTime, irrklang::ISoundEngine *sound, Player* CPlayer)
{
	...
	playerShoot(graphics,CPlayer,sound);
}
...
void gameManager::playerShoot(irr::IrrlichtDevice *graphics,Player* CPlayer, irrklang::ISoundEngine *sound)
{
