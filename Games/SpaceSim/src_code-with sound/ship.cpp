...
CShip::CShip(irr::IrrlichtDevice *graphics,irrklang::ISoundEngine *sound,  const core::vector3df& ship_position,ship_class s_class,ship_faction faction, ship_types type, const wchar_t *name)
{
